...
# N.B. This file dependencies have to be given as generated by the StanfordCoreNLP Server.
# Although it has considerable time delays it is much more accurate (over Spacy)
...
def __prep_dic(co_dict):
    ...
    :return: coref_dict i.e. {sentence_no:[coreferenced_word,...],...}
    :rtype: dict
    """
        ...
        if sent_num in prep_dict.keys():
            ...
            for index, value in enumerate(prep_indices):
                ...
                if len(coref_prep_list) > index:
                    ...
                    # Removing the pronouns which doesn't have coreferences from the indices dict
                    del indices[value]
        else:
